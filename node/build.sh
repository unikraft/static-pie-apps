...
pushd libgpg-error-1.45 > /dev/null 2>&1
./configure
make install
popd > /dev/null 2>&1
echo -n "Downloading npth....."
pushd npth1.6 > /dev/null 2>&1
./configure
make install
popd > /dev/null 2>&1
echo -n "Downloading libksba ....."
pushd libksba-1.6.0 > /dev/null 2>&1
./configure
make install
popd > /dev/null 2>&1
echo -n "Downloading libgcrypt......"
pushd libgcrypt-1.10.1 > /dev/null 2>&1
./configure
make install
popd > /dev/null 2>&1
echo -n "Downloading libassuan......"
pushd libassuan-2.5.5 > /dev/null 2>&1
./configure
make install
popd > /dev/null 2>&1
...
pushd gnupg-$NODE_VERSION > /dev/null 2>&1
./configure
make install
popd > /dev/null 2>&1
rm *.html *.tar*
